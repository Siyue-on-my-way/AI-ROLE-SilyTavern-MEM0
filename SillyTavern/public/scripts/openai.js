...
export const settingsToUpdate = {
    ...
    mem0_enabled: ['#mem0_enabled', 'mem0_enabled', true, false],
    mem0_base_url: ['#mem0_base_url', 'mem0_base_url', false, false],
    mem0_timeout_ms: ['#mem0_timeout_ms', 'mem0_timeout_ms', false, false],
    mem0_limit: ['#mem0_limit', 'mem0_limit', false, false],
    mem0_max_chars: ['#mem0_max_chars', 'mem0_max_chars', false, false],
    mem0_threshold: ['#mem0_threshold', 'mem0_threshold', false, false],
    mem0_rewrite_enabled: ['#mem0_rewrite_enabled', 'mem0_rewrite_enabled', true, false],
    mem0_rewrite_prompt: ['#mem0_rewrite_prompt', 'mem0_rewrite_prompt', false, false],
...
async function sendOpenAIRequest(type, messages, signal, { jsonSchema = null } = {}) {
    ...
    const maybeNumber = (v) => (v === '' || v === null || v === undefined) ? undefined : Number(v);
    const mem0TimeoutMs = maybeNumber(oai_settings.mem0_timeout_ms);
    const mem0Limit = maybeNumber(oai_settings.mem0_limit);
    const mem0MaxChars = maybeNumber(oai_settings.mem0_max_chars);
    const mem0Threshold = maybeNumber(oai_settings.mem0_threshold);
    const mem0 = {
        enabled: Boolean(oai_settings.mem0_enabled),
        baseUrl: String(oai_settings.mem0_base_url || '').trim() || undefined,
        timeoutMs: Number.isFinite(mem0TimeoutMs) ? mem0TimeoutMs : undefined,
        limit: Number.isFinite(mem0Limit) ? mem0Limit : undefined,
        maxChars: Number.isFinite(mem0MaxChars) ? mem0MaxChars : undefined,
        threshold: Number.isFinite(mem0Threshold) ? mem0Threshold : undefined,
    };
    const generate_data = {
        'type': type,
        'messages': messages,
        ...
        'group_chat_id': selected_group ? getCurrentChatId() : undefined,
...
async function saveOpenAIPreset(name, settings, triggerUi = true) {
    const presetBody = {
        ...
        mem0_timeout_ms: settings.mem0_timeout_ms,
        mem0_limit: settings.mem0_limit,
        mem0_max_chars: settings.mem0_max_chars,
        mem0_threshold: settings.mem0_threshold,
        mem0_rewrite_enabled: settings.mem0_rewrite_enabled,
        mem0_rewrite_prompt: settings.mem0_rewrite_prompt,
